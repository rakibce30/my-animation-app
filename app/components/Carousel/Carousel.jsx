...
import { carouselVariants } from '../animate'
...
const Carousel = () => {
    ...
    return (
        <div className='py-6 flex w-screen overflow-hidden'>
            <motion.div
            variants={carouselVariants}
            initial='hidden'
            animate='visible'
            className='grid grid-cols-[1.33fr_1.1fr_0.8fr_1.4fr_0.9fr] mx-4 items-center gap-4 min-w-[100vw]'>
            ...
            initial='hidden'
            animate='visible'
            className='grid grid-cols-[1.33fr_1.1fr_0.8fr_1.4fr_0.9fr] items-center gap-4 min-w-[100vw]'>
                <div className='flex flex-col gap-4'>
                    <Image className='rounded-3xl ring-2 ring-gray-300 p-2' src='/asset/img1.jpg' alt='img' width={1000} height={1000} />
                    <Image className='rounded-3xl ring-2 ring-gray-300 p-2' src='/asset/img2.jpg' alt='img' width={1000} height={1000} />
                </div>
